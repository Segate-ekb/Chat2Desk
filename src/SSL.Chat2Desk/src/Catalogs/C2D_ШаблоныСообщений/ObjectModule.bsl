...
Процедура ЗаполнитьНаОснованииЭлектронноеПисьмоИсходящее(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	ТипТекстаПисьма = Перечисления.C2d_СпособыРедактированияЭлектронныхПисем.ОбычныйТекст;
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.РаботаСПочтовымиСообщениями") Тогда
		...
		Если ДанныеЗаполнения.ТипТекста = ТипыТекстовЭлектронныхПисемHTML
			...
			ТипТекстаПисьма = Перечисления.C2d_СпособыРедактированияЭлектронныхПисем.HTML;
		КонецЕсли;
...
Процедура ЗаполнитьНаОснованииСтруктуры(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	ПараметрыШаблона = C2D_ШаблоныСообщений.ОписаниеПараметровШаблона();
	...
	Если ПараметрыШаблона.ТипШаблона = "Письмо" Тогда
		...
		Если ПараметрыШаблона.ФорматПисьма = Перечисления.C2d_СпособыРедактированияЭлектронныхПисем.HTML Тогда
