...
Функция ПриОпределенииНастроек() Экспорт
	...
	ОбщиеРеквизитыДерево = C2D_ШаблоныСообщенийСлужебный.ОпределитьОбщиеРеквизиты();
	Настройки.ОбщиеРеквизиты = C2D_ШаблоныСообщенийСлужебный.ОбщиеРеквизиты(ОбщиеРеквизитыДерево);
	Настройки.ПредметыШаблонов = C2D_ШаблоныСообщенийСлужебный.ОпределитьПредметыШаблонов();
	
	C2D_ШаблоныСообщенийПереопределяемый.ПриОпределенииНастроек(Настройки);
