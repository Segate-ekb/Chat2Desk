...
//                                при отправке;
//   * ФорматПисьма - ПеречислениеСсылка.C2d_СпособыРедактированияЭлектронныхПисем - вид текста письма: HTML или ОбычныйТекст;
...
Функция ОписаниеПараметровШаблона() Экспорт
	...
	Результат.Вставить("ТипШаблона", "Chat2Desk");
	Результат.Вставить("Назначение", "");
	Результат.Вставить("ПолноеИмяТипаНазначения", "");
	Результат.Вставить("ФорматПисьма", ПредопределенноеЗначение("Перечисление.C2d_СпособыРедактированияЭлектронныхПисем.ОбычныйТекст"));
	Результат.Вставить("УпаковатьВАрхив", Ложь);
	Результат.Вставить("ТранслитерироватьИменаФайлов", Истина);
