...
//                                             процедуры C2D_ШаблоныСообщенийПереопределяемый.ПриФормированииСообщения. 
//
...
//      * Результат - СправочникСсылка.C2D_ШаблоныСообщений - выбранный шаблон.
...
//
// Параметры:
//  Значение - СправочникСсылка.C2D_ШаблоныСообщений
//           - Структура
...
//                     структуры. Описание полей. см. C2D_ШаблоныСообщенийКлиентСервер.ОписаниеПараметровШаблона.
...
Процедура ПоказатьФормуШаблона(Значение, ПараметрыОткрытия = Неопределено) Экспорт
	...
	ИначеЕсли ТипЗнч(Значение) = Тип("СправочникСсылка.C2D_ШаблоныСообщений") Тогда
	...
	ОткрытьФорму("Справочник.C2D_ШаблоныСообщений.ФормаОбъекта", ПараметрыФормы, ПараметрыОткрытияФормы.Владелец,
...
Процедура ПоказатьФормуСформироватьСообщение(ОписаниеОповещенияОЗакрытии, ПараметрыФормы)
	...
	ОткрытьФорму("Справочник.C2D_ШаблоныСообщений.Форма.СформироватьСообщение", ПараметрыФормы, ЭтотОбъект,,,, Оповещение);
